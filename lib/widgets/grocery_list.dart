...
class _GroceryListState extends State<GroceryList> {
  ...
  void _loadItems() async {
    final url = Uri.https(
      'flutter-shopping-list-ap-ecb85-default-rtdb.firebaseio.com',
      'shopping_list.json',
    );
    ...
    try {
      ...
      // if no item, the firebase returns null in string and loading is keep running hence, we to do the following check.
  ...
  void _removeItem(GroceryItem item) async {
    ...
    // undo the deleted item, if error occurs
    if (response.statusCode >= 400) {
      setState(() {
